...
public interface EmailService {
    ...
    class EmailConfigurationException extends Exception {
        EmailConfigurationException(String badField, EmailException e) {
